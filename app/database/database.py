...
class Database:
  ...
  # Get All events
    ...
    def get_distinct_events(self, search_criteria, filter_event_name):
        ...
        if search_criteria != "" :
                QUERY_STR = QUERY_STR + " AND " + SEARCH_CRITERIA + ORDER_BY_FOR_FILTER
    ...
    def get_distinct_cities(self, search_criteria, filter_city_name):
    ...
    def get_distinct_artists(self, search_criteria, filter_artist_name):
